...
//
// 데모 사건은 소장 유형(complaintTypes)마다 한 건씩 다섯 건만 둔다.
// 유형별로 화면이 무엇을 다르게 보여 주는지는 한 건이면 다 확인되고,
// 같은 유형을 여러 건 두면 목록만 길어져 어느 것이 기준인지 흐려진다.
//
...
// 증거목록 서식의 「작성자」·「작성일」란은 제출일이 아니라 **그 서류가 만들어진 때**를 적는다.
// 그래서 docAuthor/docDate를 따로 둔다 — date는 제출일 또는 제출기한이라 서로 다른 값이다.
export const evidenceList = [
  { no: 1, code: '갑 제1호증', status: '제출완료', tone: 'green', file: '임대차계약서.pdf', size: '2.3 MB', date: dayOffset(-45), dateLabel: '제출일', purpose: '임대차 계약 관계 및 보증금 1,000만원 지급 사실 입증', docAuthor: '홍길동·김철수', docDate: '2024-01-01' },
  { no: 2, code: '갑 제2호증', status: '제출완료', tone: 'green', file: '보증금_입금증.jpg', size: '1.1 MB', date: dayOffset(-45), dateLabel: '제출일', purpose: '보증금 1,000만원을 피고에게 실제 지급한 사실 입증', docAuthor: '국민은행', docDate: '2024-01-01' },
  { no: 3, code: '갑 제3호증', status: '제출예정', tone: 'blue', file: '문자_납부내역.pdf', size: '856 KB', date: EVID_DUE, dateLabel: '기한', purpose: '월세를 성실히 납부한 사실 입증', docAuthor: '국민은행', docDate: '2025-12-31' },
  { no: 4, code: '갑 제4호증', status: '보완필요', tone: 'amber', file: '카카오톡_대화내용.pdf', size: '3.2 MB', date: BRIEF_DUE, dateLabel: '기한', purpose: '피고가 보증금 반환을 회피한 사실 입증 (대화 내용 일부 가려야 함)', warn: '카톡 캡처에 제3자 개인정보가 보입니다. 가린 뒤 다시 제출하세요.', docAuthor: '홍길동·김철수', docDate: '2026-02-18' },
  { no: 5, code: '갑 제5호증', status: '미제출', tone: 'gray', file: '하자보수_사진1.jpg', size: '2.8 MB', date: EVID_DUE, dateLabel: '기한', purpose: '임차인이 원상복구 의무를 다한 사실 입증', docAuthor: '홍길동', docDate: '2026-01-03' },
  { no: 6, code: '갑 제6호증', status: '미제출', tone: 'gray', file: '하자보수_사진2.jpg', size: '2.5 MB', date: EVID_DUE, dateLabel: '기한', purpose: '임차인이 원상복구 의무를 다한 사실 입증', docAuthor: '홍길동', docDate: '2026-01-03' },
].map((item, index) => {
...
/**
 * 데모 사건 다섯 건 — **소장 유형마다 한 건씩**이다.
 *
 * 소장 유형은 complaintTypes 다섯 가지(대여금·임대차보증금·임금체불·손해배상·건물명도)이고,
 * 화면이 유형별로 무엇을 다르게 보여 주는지는 한 건씩만 있으면 다 확인된다.
 * 같은 유형을 여러 건 두면 목록만 길어지고 어느 것이 기준인지 흐려진다.
 *
...
export const demoBoardRows = [
  ...
  demoDoc('labor', { key: 'd-e7', group: 'evidence', docAuthor: '홍길동·김철수', docDate: '2023-03-06', evNo: 1, code: '갑 제1호증', title: '근로계약서.pdf', purpose: '근로조건과 계약 기간을 정한 사실 입증', size: '1.4 MB', status: '미제출', due: dayOffset(12) }),
  demoDoc('labor', { key: 'd-e8', group: 'evidence', docAuthor: '국민은행', docDate: '2026-06-25', evNo: 2, code: '갑 제2호증', title: '급여이체내역.pdf', purpose: '2025년 1월부터 6월까지 급여가 일부만 지급된 사실 입증', size: '0.8 MB', status: '미제출', due: dayOffset(12) }),
  demoDoc('labor', { key: 'd-e9', group: 'evidence', docAuthor: '김철수', docDate: '2026-06-20', evNo: 3, code: '갑 제3호증', title: '사내메신저_지시내용.pdf', purpose: '연장근로를 지시받은 사실 입증', size: '2.1 MB', status: '미제출', due: dayOffset(12) }),
  demoDoc('loan', { key: 'd-e10', group: 'evidence', docAuthor: '김철수', docDate: '2023-08-10', evNo: 1, code: '갑 제1호증', title: '차용증.jpg', purpose: '2023. 8. 500만원을 빌려준 사실 입증', size: '1.0 MB', status: '제출완료', submittedAt: dayOffset(-31) }),
  demoDoc('loan', { key: 'd-e11', group: 'evidence', docAuthor: '국민은행', docDate: '2023-08-10', evNo: 2, code: '갑 제2호증', title: '계좌이체_확인증.pdf', purpose: '500만원을 실제 송금한 사실 입증', size: '0.5 MB', status: '제출완료', submittedAt: dayOffset(-31) }),
  demoDoc('loan', { key: 'd-e12', group: 'evidence', docAuthor: '국민은행', docDate: '2024-02-15', evNo: 3, code: '갑 제3호증', title: '일부변제_입금내역.jpg', purpose: '피고가 100만원을 일부 변제하여 대여금 채무를 인정한 사실 입증', size: '0.4 MB', status: '보완필요', due: dayOffset(5), warn: '입금자명이 가려져 있어요. 원본 내역서로 다시 받아 주세요.' }),
  ...
  demoDoc('crash', { key: 'd-e13', group: 'evidence', docAuthor: '서울노원경찰서', docDate: '2025-09-15', evNo: 1, code: '갑 제1호증', title: '교통사고사실확인원.pdf', purpose: '2025. 9. 12. 사고 발생 사실과 가해 차량을 특정', size: '0.6 MB', status: '제출완료', submittedAt: dayOffset(-54) }),
  demoDoc('crash', { key: 'd-e14', group: 'evidence', docAuthor: '노원정형외과의원', docDate: '2025-09-13', evNo: 2, code: '갑 제2호증', title: '진단서_12주.pdf', purpose: '경추 염좌 등으로 12주 치료를 요한 사실 입증', size: '0.4 MB', status: '제출완료', submittedAt: dayOffset(-54) }),
  demoDoc('crash', { key: 'd-e15', group: 'evidence', docAuthor: '노원정형외과의원 외', docDate: '2025-12-05', evNo: 3, code: '갑 제3호증', title: '치료비_영수증_모음.pdf', purpose: '실제 지출한 치료비 합계 4,120,000원 입증', size: '1.7 MB', status: '제출완료', submittedAt: dayOffset(-54) }),
  demoDoc('crash', { key: 'd-e16', group: 'evidence', docAuthor: '홍길동', docDate: '2025-09-12', evNo: 4, code: '갑 제4호증', title: '블랙박스_캡처.jpg', purpose: '피고 차량이 중앙선을 침범한 사실 입증', size: '2.9 MB', status: '검토중', due: dayOffset(8) }),
  demoDoc('crash', { key: 'd-e17', group: 'evidence', docAuthor: '주식회사 대한물류', docDate: '2025-12-10', evNo: 5, code: '갑 제5호증', title: '휴업손해_급여명세서.pdf', purpose: '치료 기간 중 근로하지 못해 발생한 일실수입 입증', size: '0.5 MB', status: '보완필요', due: dayOffset(4), warn: '동료 직원의 급여액이 함께 보입니다. 본인 부분만 남기고 가려 주세요.' }),
  ...
  demoDoc('evict', { key: 'd-e18', group: 'evidence', docAuthor: '홍길동·김철수', docDate: '2023-04-01', evNo: 1, code: '갑 제1호증', title: '상가임대차계약서.pdf', purpose: '임대차 계약의 성립과 차임 약정 입증', size: '2.1 MB', status: '제출완료', submittedAt: dayOffset(-19) }),
  demoDoc('evict', { key: 'd-e19', group: 'evidence', docAuthor: '홍길동', docDate: '2025-11-01', evNo: 2, code: '갑 제2호증', title: '차임_연체내역.pdf', purpose: '2025. 4.부터 7기분 차임이 연체된 사실 입증', size: '0.7 MB', status: '제출완료', submittedAt: dayOffset(-19) }),
  demoDoc('evict', { key: 'd-e20', group: 'evidence', docAuthor: '홍길동', docDate: '2025-11-03', evNo: 3, code: '갑 제3호증', title: '계약해지_내용증명.pdf', purpose: '2025. 11. 3. 계약 해지를 통고하고 도달한 사실 입증', size: '0.9 MB', status: '제출완료', submittedAt: dayOffset(-19) }),
  demoDoc('evict', { key: 'd-e21', group: 'evidence', docAuthor: '수원지방법원 등기국', docDate: '2025-11-20', evNo: 4, code: '갑 제4호증', title: '등기사항전부증명서.pdf', purpose: '원고가 목적물의 소유자인 사실 입증', size: '1.3 MB', status: '제출예정', due: dayOffset(7) }),
...
const evidenceFileForCase = (item, index) => ({
  ...
  // 증거목록 서식의 「작성자」·「작성일」 — 서류가 만들어진 때이지 제출한 때가 아니다
...
export const figmaWorkspaceCases = [
  {
    // 임대차보증금 · 변론 — 접수 후 기일이 잡혀 서면이 오가는 중
    ...
    form: {
      ...
      demandResult: '내용증명은 받았는데 답이 없어요. 전화하면 안 받고, 문자로만 조금만 더 기다려 달라고 합니다.',
      evidenceItems: ['임대차계약서', '보증금 입금내역', '문자·카톡 대화'],
      attachExtra: ['부동산 등기사항증명서', '주민등록초본'],
      attachFiles: [
        { id: 'lease-at-1', name: '부동산 등기사항증명서', fileName: '등기사항전부증명서_관악구.pdf', size: 412_000, type: 'application/pdf' },
        { id: 'lease-at-2', name: '주민등록초본', fileName: '주민등록초본_홍길동.pdf', size: 128_000, type: 'application/pdf' },
      ],
  ...
  {
    // 임금체불 · 소장 작성 중 — 내용증명·진정까지 마치고 소장을 쓰는 중 (80%)
    id: 'demo-labor-case', kind: 'complaint', typeKey: 'wage', title: '임금체불 청구', caseNo: '2026가단221457', filedAt: dayOffset(-23), filedVia: '전자소송', status: '진행 중',
    entryPoint: 'filed', flowDone: {},
    form: {
      ...
      unpaidItems: ['임금', '연장근로수당'], calcWage: '6200000', calcOvertime: '1200000',
      calcBasis: '2026년 5월분과 6월분 월급 310만원씩 620만원을 못 받았고, 그 두 달 동안 주 6일 근무하면서 생긴 연장근로수당 120만원도 안 나왔어요. 합쳐서 740만원입니다.',
      laborReport: '진정 접수함', reportNo: '2026-서울남부-01234', reportDoc: '발급 완료',
      demandWay: '내용증명을 보냈어요', demandDate: dayOffset(-24),
      demandResult: '내용증명 받고 나서 대표가 전화로 자금 사정이 나아지면 주겠다고만 했어요. 언제 준다는 말은 없었습니다.',
      evidenceItems: ['근로계약서', '통장 입금내역', '문자·카톡 대화'],
      attachExtra: ['주민등록초본'],
      attachFiles: [
        { id: 'labor-at-1', name: '주민등록초본', fileName: '주민등록초본_홍길동.pdf', size: 121_000, type: 'application/pdf' },
      ],
      evidenceFiles: evidenceFilesFor('2024가단998877'),
    },
    statusAt: { '작성 중': Date.now() - 86400000 * 28, '제출 준비': Date.now() - 86400000 * 26, '접수함': Date.now() - 86400000 * 23, '진행 중': Date.now() - 86400000 * 10 },
    todos: [
      { id: 'demo-labor-todo-1', text: '준비서면(1) 제출 — 근로자성 반박', due: dayOffset(18), done: false, typeKey: 'prepare', remind: 3, createdAt: Date.now() - 86400000 * 8 },
      { id: 'demo-labor-todo-2', text: '체불금품확인원 원본 지참', due: dayOffset(25), done: false, typeKey: 'prepare', createdAt: Date.now() - 86400000 * 5 },
      { id: 'demo-labor-todo-3', text: '소장 최종 검토', due: dayOffset(-25), done: true, doneAt: Date.now() - 86400000 * 25, createdAt: Date.now() - 86400000 * 28 },
    ],
    events: [
      { id: 'demo-labor-event-1', kind: 'doc', title: '소장 초안 생성', desc: '연장근로 내역 반영', at: Date.now() - 86400000 * 27, source: 'app' },
      { id: 'demo-labor-event-2', kind: 'status', title: '법원 접수 — 사건번호 2026가단221457', desc: '전자소송', at: Date.now() - 86400000 * 23, source: 'user' },
      { id: 'demo-labor-event-3', kind: 'user', title: '피고 답변서 수령', desc: '근로자성 부인 — 도급계약 주장', at: Date.now() - 86400000 * 9, source: 'user' },
    ],
    precedentNos: ['2023두54914'],
    docs: [
  ...
  },
  {
    ...
    form: {
      ...
      repaid: '일부 돌려받았어요', repaidAmount: '1000000', repaidDate: '2024-02-15', repaidKind: '원금에서 빼기',
      demandWay: '내용증명을 보냈어요', demandDate: dayOffset(-46),
      demandResult: '100만원 보내고는 나머지는 사정이 나아지면 준다고 했어요. 그 뒤로는 연락을 피하고 문자도 읽고 답이 없습니다.',
      evidenceItems: ['차용증·금전소비대차계약서', '계좌이체 내역'],
      attachExtra: ['주민등록초본'],
      attachFiles: [
        { id: 'loan-at-1', name: '주민등록초본', fileName: '주민등록초본_홍길동.pdf', size: 121_000, type: 'application/pdf' },
      ],
      evidenceFiles: evidenceFilesFor('2024가소445566'),
    },
  ...
  },
  {
    ...
    form: { court: '서울북부지방법원', claimKind: '재산권상 청구', sueValueKind: '금액', amount: '18600000', courtDept: '제3민사단독', pName: '홍길동', pRrn: '880417-1******', pAddr: '서울특별시 동작구 상도로 200', pAddrDetail: '1102호', pTel: '010-2841-7306', pEmail: 'gildong.hong@example.com', pService: '위 주소와 같음', pFax: '02-6952-1408', pEntity: '개인 (자연인)', pLegalRep: '해당 없음', pForeignName: 'HONG GILDONG', dName: '김철수', dAddr: '서울특별시 강남구 테헤란로 152', dAddrDetail: '1204호', dTel: '010-9274-1185', dRrn: '761208-1******', dCount: '한 명', dEntity: '개인 (자연인)', dLegalRep: '해당 없음', hasContract: '없음 (사고·불법행위)', tortKind: '교통사고 (자)', incidentDate: '2025-09-12', claimAmount: '18600000', incidentStory: '피고는 2025. 9. 12. 14:20경 서울특별시 노원구 상계동 교차로에서 승용차를 운전하던 중 중앙선을 침범하여 반대편에서 정상 진행하던 원고 운전 차량의 좌측면을 충격하였습니다.', damageKinds: ['치료비·수리비 (적극손해)', '일하지 못한 손해 (일실수입)', '위자료'], dmgDirect: '4120000', dmgIncome: '9480000', dmgSolace: '5000000', ownFault: '없음', calcBasis: '치료비는 영수증 합계, 일실수입은 사고 전 3개월 평균임금 기준 휴업 12주로 산정하였습니다. 위자료는 상해 정도와 치료 기간을 고려한 금액입니다.', calcDocs: ['진단서·소견서', '치료비 영수증', '급여명세서·소득금액증명', '사고사실확인원'], demandWay: '내용증명을 보냈어요', demandDate: dayOffset(-62),
      ...
      attachExtra: ['주민등록초본'],
      attachFiles: [
        { id: 'crash-at-1', name: '주민등록초본', fileName: '주민등록초본_홍길동.pdf', size: 118_000, type: 'application/pdf' },
      ],
      evidenceFiles: evidenceFilesFor('2025가단334455') },
  ...
  {
    // 건물명도 · 법원 접수 완료 — 사건번호는 받았고 아직 기일통지서 전
    ...
    form: {
      ...
      unpaidFrom: '2025-04-01', unpaidMonths: '7', unpaidUtil: '860000',
      unpaidDetail: '2025. 4.부터 2025. 10.까지 7개월분 차임 1,400만원과 관리비·공과금 86만원이 밀려 있습니다.',
      terminated: '통고했어요', terminateDate: '2025-11-03',
      evictStory: '처음 두어 달은 늦게라도 넣더니 2025년 4월부터는 아예 안 들어왔어요. 전화하면 곧 넣겠다고만 하고 계속 장사는 하고 있습니다. 7개월 밀렸을 때 내용증명으로 계약 해지한다고 보냈는데도 그대로예요.',
      demandWay: '내용증명을 보냈어요', demandDate: '2025-11-03',
      demandResult: '내용증명은 받았는데 답이 없고 계속 영업하고 있어요. 가게를 비워줄 생각이 없어 보입니다.',
      evidenceItems: ['임대차계약서', '부동산 등기부등본', '미납 차임 내역·통장거래내역', '해지·종료 통보 내용증명'],
      attachExtra: ['소가계산서', '주민등록초본', '부동산 등기사항증명서'],
      attachFiles: [
        { id: 'evict-at-1', name: '소가계산서', fileName: '소가계산서_건물명도.pdf', size: 96_000, type: 'application/pdf' },
        { id: 'evict-at-2', name: '주민등록초본', fileName: '주민등록초본_홍길동.pdf', size: 121_000, type: 'application/pdf' },
        { id: 'evict-at-3', name: '부동산 등기사항증명서', fileName: '등기사항전부증명서_세화로44.pdf', size: 388_000, type: 'application/pdf' },
      ],
      evidenceFiles: evidenceFilesFor('2025가단776655'),
    },
