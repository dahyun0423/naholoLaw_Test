...
export const precedents = [
  {
    ...
    court: '대법원', no: '2022다123456', issues: ['동시이행 항변', '임대차보증금'], date: '2023.06.15', relevance: 95,
  ...
  },
  {
    ...
    court: '서울고등법원', no: '2023나987654', issues: ['지연손해금', '임대차보증금'], date: '2023.08.22', relevance: 92,
  ...
  },
  {
    ...
    result: '원고일부승소', tone: 'amber',
    court: '대법원', no: '2021다456789', issues: ['공제 주장 (원상회복비 등)', '임대차보증금'], date: '2022.11.30', relevance: 88,
  ...
  },
  {
    ...
    result: '원고승소', tone: 'green',
    court: '서울중앙지방법원', no: '2023가소321456', issues: ['소액사건', '임대차보증금'], date: '2024.01.10', relevance: 75,
    point: '소액사건심판법에 의해 이행권고결정으로 신속하게 보증금 반환이 인용된 사건.',
    apply: '청구금액 2천만원 이하이므로 소액사건으로 진행 가능합니다. 1~2개월 내에 이행권고결정이 나올 수 있어요.',
  },

  {
    title: '대여금 청구와 소멸시효 중단',
    result: '원고승소', tone: 'green',
    court: '대법원', no: '2020다112233', issues: ['소멸시효 항변', '대여금'], date: '2021.04.29', relevance: 90,
    point: '채무자가 일부라도 변제하면 채무를 승인한 것으로 보아 그 시점부터 소멸시효가 새로 진행한다.',
    apply: '상대방이 소멸시효를 주장하면, 일부 변제·이자 지급·상환 약속 문자 등 채무 승인 사실을 들어 시효 중단을 주장하세요.',
  },
  {
    title: '대여금 반환청구 — 변제 항변의 증명책임',
    result: '원고승소', tone: 'green',
    court: '대법원', no: '2019다445566', issues: ['변제 항변', '대여금'], date: '2020.09.03', relevance: 88,
    point: '변제 사실은 이를 주장하는 채무자가 증명해야 하며, 단순한 송금 내역만으로는 이 사건 채무의 변제로 단정할 수 없다.',
    apply: '상대방이 "이미 갚았다"고 하면, 그 송금이 이 사건 대여금과 무관하다는 점을 지적하고 증명책임이 상대방에게 있음을 밝히세요.',
  },
  {
    title: '금전소비대차 — 차용증 없는 대여사실의 증명',
    result: '원고일부승소', tone: 'amber',
    court: '서울중앙지방법원', no: '2022가단778899', issues: ['전부 부인 (그런 사실 없다)', '대여금'], date: '2023.02.14', relevance: 85,
    point: '차용증이 없더라도 계좌이체 내역과 반환을 약속한 메시지 등을 종합하면 소비대차 약정을 인정할 수 있다.',
    apply: '상대방이 "빌린 적 없다, 투자금이다"라고 부인할 때 이체내역·대화기록을 묶어 대여 약정을 입증하는 근거로 쓰세요.',
  },
  {
    title: '임금 및 퇴직금 청구',
    result: '원고승소', tone: 'green',
    court: '대법원', no: '2021다334455', issues: ['임금체불', '지연손해금'], date: '2022.05.26', relevance: 91,
    point: '퇴직일부터 14일이 지나도록 지급하지 않은 임금·퇴직금에는 연 20%의 지연이자가 가산된다.',
    apply: '청구취지에 "퇴직일부터 14일이 지난 다음 날부터 연 20%"를 명시할 때 근거로 인용하세요.',
  },
  {
    title: '손해배상 — 과실상계와 위자료 산정',
    result: '원고일부승소', tone: 'amber',
    court: '대법원', no: '2020다667788', issues: ['과실상계 주장', '손해배상'], date: '2021.11.11', relevance: 87,
    point: '피해자의 과실은 손해의 발생·확대에 기여한 범위에서만 참작되며, 위자료는 제반 사정을 종합하여 정한다.',
    apply: '상대방이 과실상계를 과도하게 주장하면 그 과실이 손해와 인과관계가 있는지부터 다투세요.',
  },
  {
    title: '상계 항변의 요건',
    result: '원고승소', tone: 'green',
    court: '대법원', no: '2018다990011', issues: ['상계 항변'], date: '2019.07.25', relevance: 84,
    point: '상계를 하려면 상대방에 대한 반대채권이 실제로 존재하고 변제기가 도래해야 한다.',
    apply: '상대방이 상계를 주장하면 반대채권의 존재 자체와 변제기 도래 여부를 먼저 다투세요.',
  },
  {
    title: '건물명도 — 차임 연체와 계약 해지',
    result: '원고승소', tone: 'green',
    court: '대법원', no: '2019다223344', issues: ['건물명도', '차임 연체'], date: '2020.03.12', relevance: 89,
    point: '차임 연체액이 2기의 차임액에 달하면 임대인은 계약을 해지할 수 있고, 해지 의사표시가 도달한 때 계약이 종료된다.',
    apply: '해지 통고 내용증명의 도달일을 특정해 계약 종료 시점을 주장할 때 인용하세요.',
  },
  {
    title: '가압류 — 보전의 필요성 소명 정도',
    result: '인용', tone: 'green',
    court: '대법원', no: '2017마556677', issues: ['보전의 필요성', '가압류'], date: '2018.01.30', relevance: 82,
    point: '보전의 필요성은 채무자의 재산 처분 정황 등으로 소명하면 족하고 엄격한 증명을 요하지 않는다.',
    apply: '가압류 신청서의 보전의 필요성 항목에서 재산 처분 정황을 소명할 때 근거로 씁니다.',
  },
]
...
export const winrate = {
  ...
  laws: [
    { name: '민법 제618조 (임대차의 의의)', tag: '참고', tone: 'gray' },
